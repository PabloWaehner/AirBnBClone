...
// we make up our own hook: useControlledInput
            ...
            <form onSubmit={submitSearch} className="search-box-form">
                <div className="col m12">
                    ...
                    <div className="input-field" id="where">
                        <input className="browser-default" placeholder="Anywhere" {...where} type="text" /> {/*with replace value="" and onChange="" with {...where} */}
                    </div>
                </div>
