...
class Account extends Component {
    ...
    render() {
        const { pastBookings, upcomingBookings } = this.state; //destructuring
            ...
            <div className="account container-fluid">
                ...
                <div className="row">
                    <div className="col s8 offset-s3">
                        ...
                        <Route exact path="/account/reservations/confirmed" render={() => //we need to pass props, that's why we can't do component={Bookings}
